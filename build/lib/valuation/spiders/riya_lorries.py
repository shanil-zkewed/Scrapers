...
class RiyaSpider(scrapy.Spider):
    ...
    start_urls = ["https://riyasewana.com/search/lorries"]
    ...
    def parse(self, response):
        ...
        for i in range(1,6):
            next_page = "https://riyasewana.com/search/lorries?page="+str(i)      
    ...
    def parse_veh_page(self, response):
        ...
        carItem["make"] = table_rows[3].css('td::text')[0].get(),
        carItem["model"] = table_rows[3].css('td::text')[1].get(),
        carItem["year"] = table_rows[4].css('td::text')[0].get(),
        carItem["price"] = table_rows[2].css('td span.moreph::text')[1].get(),
        carItem["mileage"] = table_rows[4].css('td::text')[1].get(),
        carItem["gear"]=table_rows[5].css('td::text')[0].get(),
        carItem["fuel_type"]= table_rows[5].css('td::text')[1].get(),
        carItem["engine_capability"] = table_rows[6].css('td::text')[1].get(),
        ...
        yield{
            ...
            "make" : table_rows[3].css('td::text')[0].get(),
            "model" : table_rows[3].css('td::text')[0].get(),
            "year": table_rows[4].css('td::text')[0].get(),
            "price": table_rows[2].css('td span.moreph::text')[1].get(),
            "mileage" : table_rows[4].css('td::text')[1].get(),
            "gear":table_rows[5].css('td::text')[0].get(),
            "fuel":table_rows[5].css('td::text')[1].get(),
            "engine": table_rows[6].css('td::text')[1].get(),
            "location": heading.css('h2::text').get(),
            "date" :heading.css("h2::text").get(),
            "options": table_rows[6].css('td::text')[0].get()
        }
        '''